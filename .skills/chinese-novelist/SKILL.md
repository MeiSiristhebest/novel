...
description: |
  (PRO版 v6.3.1) 顶级作家模拟系统。分章节创作顶级中文小说。
  ...
  **核心升级**：
  ...
  - 平台实时对齐：涉及“最新榜单/趋势/AI审核/合规口径”的结论必须基于快照，禁止凭空推断
  - 超长篇架构系统：支持1000章+史诗级巨作的完整规划（多级卷/弧线目录动态路由）
  - 群像生态系统：支持10-15人高密度群像剧的动态平衡控制与高光时刻调度
  - 职业作家工具包：卡文急救、日更生存、修订工作流、读者运营
  - 7阶段创作工作流：选题→人设→大纲→存稿→连载→修改→反馈
  - 动态上下文滑动窗口：基于层级的全局/卷/弧线设定无缝路由加载
...
# Chinese Novelist Pro v6.3.1: 顶级作家模拟系统
