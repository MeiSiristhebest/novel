...
| `00-全局设定/04-伏笔追踪表.md` | 标记已揭示的伏笔、添加新埋的伏笔 |
| `00-全局设定/05-时间线.md` | 添加本章时间节点和事件 |
| `00-全局设定/06-细节追踪表.md` | 更新人物/物品/地点的状态变化（`00-全局设定/08-素材碎片.md` 仅作可选补充） |

> SSOT 规则：运行时状态以 `.context/` 为准；衍生视图建议通过 `tools/sync_project_views.py` 同步到 `03-分章细纲.md` + `00-全局设定/`。
