...
| # | 文件 | 用途 |
|:--|:-----|:-----|
| 9 | `novels/[书名]/00-策划书.md` | 核心设定 |
| 10 | `novels/[书名]/01-世界观圣经.md` | 世界观规则 |
| 11 | `novels/[书名]/02-人物深度档案.md` | 角色数据 |
| 12 | `novels/[书名]/03-分章细纲.md` | 章节大纲 |
| 13 | `novels/[书名]/04-伏笔追踪表.md` | 伏笔状态 |
| 14 | `novels/[书名]/05-时间线.md` | 时间节点 |
| 15 | `novels/[书名]/06-细节追踪表.md` | 人物/物品状态 |
| 16 | `novels/[书名]/07-项目状态.md` | 进度跟踪 |
